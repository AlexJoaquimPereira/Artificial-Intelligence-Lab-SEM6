...
def dfs_rule(next, visited, capacity_a, capacity_b):
    """
...
def water_jug (a:int, b:int, capacity_a, capacity_b, water_in_a):
    '''
    ...
    while stack:
        ...
        for new in dfs_rule(next, visited, capacity_a, capacity_b):
...
if __name__ == "__main__":
    ...
    path = water_jug (jug_a, jug_b, capacity_a, capacity_b, water_in_a)
    print("Solution: ", path)